...
export const saveProducto = async (req: Request, res: Response) => {
    try {
        ...
        const { nombre, categoria_producto_id, tamano, precio_venta, stock, descripcion, proveedor_id } = req.body;
        ...
        const newItem = new Producto({ nombre, categoria_producto_id, tamano, precio_venta, stock, descripcion, proveedor_id });
        await newItem.save();
...
export const updateProducto = async (req: Request, res: Response) => {
    try {
        ...
        const updatedProducto = await Producto.findByIdAndUpdate(objectId, {
            nombre, categoria_producto_id, tamano, precio_venta, stock, descripcion, proveedor_id
        }, { new: true });
